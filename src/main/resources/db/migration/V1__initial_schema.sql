...
(
    ...
    CONSTRAINT fk_medical_record_medical_appointment_number FOREIGN KEY(medical_record_medical_appointment_number) REFERENCES medical_appointment(medical_appointment_number)
);
